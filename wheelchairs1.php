...
<div class="wheelchairs-h1"><h1>Mehanička kolica</h1></div>
    ...
    <div class="wheelchairs1">
        ...
        <div class="wheelchairs1-content" data-product-id="1">
            ...
            <form method="post" action="cart.php">
                ...
                <input type="hidden" name="product_name" value="KOLICA MEHANIČKA EASY QUICK">
                <input type="hidden" name="product_price" value="30250">
        ...
        <div class="wheelchairs1-content" data-product-id="2">
            ...
            <form method="post" action="cart.php">
                ...
                <input type="hidden" name="product_name" value="KOLICA MEHANIČKA CONCEPT II">
                <input type="hidden" name="product_price" value="58300">
                <button type="submit" class="buy">Dodaj u korpu</button>
            </form>
        </div>
        ...
        <div class="wheelchairs1-content" data-product-id="3">
            ...
            <form method="post" action="cart.php">
                ...
                <input type="hidden" name="product_name" value="KOLICA MEHANIČKA LIGHT TOP">
        ...
        <div class="wheelchairs1-content" data-product-id="4">
            ...
            <form method="post" action="cart.php">
                ...
                <input type="hidden" name="product_name" value="KOLICA MEHANIČKA ULTRA LIGHT">
        ...
        <div class="wheelchairs1-content" data-product-id="5">
            ...
            <form method="post" action="cart.php">
                ...
                <input type="hidden" name="product_name" value="KOLICA MEHANIČKA COMFORT">
        ...
        <div class="wheelchairs1-content" data-product-id="6">
            ...
            <form method="post" action="cart.php">
                ...
                <input type="hidden" name="product_name" value="KOLICA MEHANIČKA COMPACT">
        ...
        <div class="wheelchairs1-content" data-product-id="7">
            ...
            <form method="post" action="cart.php">
                ...
                <input type="hidden" name="product_name" value="KOLICA MEHANIČKA ACTIVE">
        ...
        <div class="wheelchairs1-content" data-product-id="8">
            ...
            <form method="post" action="cart.php">
                ...
                <input type="hidden" name="product_name" value="KOLICA MEHANIČKA PRO">
        ...
        <div class="wheelchairs1-content" data-product-id="9">
            ...
            <form method="post" action="cart.php">
                ...
                <input type="hidden" name="product_name" value="INVALIDSKA KOLICA MEHANIČKA GOLDEN MOBIAK">
                <input type="hidden" name="product_price" value="35250">
                <button type="submit" class="buy">Dodaj u korpu</button>
            </form>
        </div>
        ...
        <div class="wheelchairs1-content" data-product-id="10">
            ...
            <form method="post" action="cart.php">
                ...
                <input type="hidden" name="product_name" value="INVALIDSKA KOLICA MEHANIČKA ACTION 3">
                <input type="hidden" name="product_price" value="30250">
                <button type="submit" class="buy">Dodaj u korpu</button>
            </form>
        </div>
        ...
        <div class="wheelchairs1-content" data-product-id="11">
            ...
            <form method="post" action="cart.php">
                ...
                <input type="hidden" name="product_name" value="INVALIDSKA KOLICA MEHANIČKA FS 903 LQ">
                <input type="hidden" name="product_price" value="31050">
                <button type="submit" class="buy">Dodaj u korpu</button>
            </form>
        </div>
        ...
        <div class="wheelchairs1-content" data-product-id="12">
            ...
            <form method="post" action="cart.php">
                ...
                <input type="hidden" name="product_name" value="INVALIDSKA KOLICA MEHANIČKA ACTION 5">
                <input type="hidden" name="product_price" value="33350">
                <button type="submit" class="buy">Dodaj u korpu</button>
            </form>
        </div>
    </div>
