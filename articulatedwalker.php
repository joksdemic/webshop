...
<div class="wheelchairs-h1"><h1>Zglobne hodalice</h1></div>
...
<div class="wheelchairs1">
    ...
    <div class="wheelchairs1-content" data-product-id="34">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="HODALICA ZGLOBNA MOBIAK TIP 919">
    ...
    <div class="wheelchairs1-content" data-product-id="35">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="HODALICA FS 919L ZGLOBNA">
            <input type="hidden" name="product_price" value="6600">
            <button type="submit" class="buy">Dodaj u korpu</button>
        </form>
    </div>
    ...
    <div class="wheelchairs1-content" data-product-id="36">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="HODALICA SA DVA TOČKA MOBIAK TIP 912">
            <input type="hidden" name="product_price" value="6600">
            <button type="submit" class="buy">Dodaj u korpu</button>
        </form>
    </div>
    ...
    <div class="wheelchairs1-content" data-product-id="37">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="HODALICA FS 9632 L ZGLOBNA, STEPENASTA">
            <input type="hidden" name="product_price" value="7150">
            <button type="submit" class="buy">Dodaj u korpu</button>
        </form>
    </div>
    ...
    <div class="wheelchairs1-content" data-product-id="38">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_price" value="7250">
            <button type="submit" class="buy">Dodaj u korpu</button>
        </form>
    </div>
    ...
    <div class="wheelchairs1-content" data-product-id="39">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="HODALICA ZGLOBNA SMART F 2360">
    ...
    <div class="wheelchairs1-content" data-product-id="40">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="HODALICA ZGLOBNA MOBIAK TIP 119">
