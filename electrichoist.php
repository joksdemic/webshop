...
<div class="wheelchairs-h1"><h1>Električne dizalice</h1></div>
...
<div class="wheelchairs1">
    ...
    <div class="wheelchairs1-content" data-product-id="133">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="ELEKTRIČNA DIZALICA JOZ">
            <input type="hidden" name="product_price" value="111500">
    ...
    <div class="wheelchairs1-content" data-product-id="134">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="ELEKTRIČNA DIZALICA DOLI">
            <input type="hidden" name="product_price" value="123500">
            <button type="submit" class="buy">Dodaj u korpu</button>
        </form>
    </div>
    ...
    <div class="wheelchairs1-content" data-product-id="135">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="ELEKTRIČNA DIZALICA SOLI">
            <input type="hidden" name="product_price" value="133590">
            <button type="submit" class="buy">Dodaj u korpu</button>
        </form>
    </div>
    ...
    <div class="wheelchairs1-content" data-product-id="136">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="ELEKTRIČNA DIZALICA H43-4">
            <input type="hidden" name="product_price" value="146150">
            <button type="submit" class="buy">Dodaj u korpu</button>
        </form>
    </div>
    ...
    <div class="wheelchairs1-content" data-product-id="137">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="ELEKTRIČNA DIZALICA H53-4">
            <input type="hidden" name="product_price" value="123700">
            <button type="submit" class="buy">Dodaj u korpu</button>
        </form>
    </div>
    ...
    <div class="wheelchairs1-content" data-product-id="138">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="ELEKTRIČNA DIZALICA D54">
    ...
    <div class="wheelchairs1-content" data-product-id="139">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="ELEKTRIČNA DIZALICA D24">
            <input type="hidden" name="product_price" value="125500">
            <button type="submit" class="buy">Dodaj u korpu</button>
        </form>
    </div>
    ...
    <div class="wheelchairs1-content" data-product-id="140">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="ELEKTRIČNA DIZALICA YOYO">
            <input type="hidden" name="product_price" value="134400">
            <button type="submit" class="buy">Dodaj u korpu</button>
        </form>
    </div>
    ...
    <div class="wheelchairs1-content" data-product-id="141">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="ELEKTRIČNA DIZALICA ZOY">
            <input type="hidden" name="product_price" value="215790">
            <button type="submit" class="buy">Dodaj u korpu</button>
        </form>
    </div>
</div>
