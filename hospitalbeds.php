...
<div class="wheelchairs-h1"><h1>Bolnički kreveti</h1></div>
...
<div class="wheelchairs1">
    ...
    <div class="wheelchairs1-content" data-product-id="115">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="KREVET BOLNIČKI EUCLIDE (BEZ TOČKOVA)">
    ...
    <div class="wheelchairs1-content" data-product-id="116">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="KREVET BOLNIČKI JASMIN">
    ...
    <div class="wheelchairs1-content" data-product-id="117">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="KREVET BOLNIČKI MEHANIČKI K008 A">
    ...
    <div class="wheelchairs1-content" data-product-id="118">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="KREVET BOLNIČKI MEHANIČKI K008 B">
    ...
    <div class="wheelchairs1-content" data-product-id="119">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="KREVET BOLNIČKI TEA">
    ...
    <div class="wheelchairs1-content" data-product-id="120">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="KREVET BOLNIČKI H32">
    ...
    <div class="wheelchairs1-content" data-product-id="121">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="KREVET BOLNIČKI TOMA">
    ...
    <div class="wheelchairs1-content" data-product-id="122">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="KREVET BOLNIČKI">
