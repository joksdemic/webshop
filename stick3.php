...
<div class="wheelchairs-h1"><h1>Štapovi sa četiri tačke oslonca</h1></div>
...
<div class="wheelchairs1">
    ...
    <div class="wheelchairs1-content" data-product-id="97">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="ŠTAP ČETVOROKRAKI FS 922">
    ...
    <div class="wheelchairs1-content" data-product-id="98">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="ŠTAP ČETVOROKRAKI FTS 342">
            <input type="hidden" name="product_price" value="1500">
            <button type="submit" class="buy">Dodaj u korpu</button>
        </form>
    </div>
    ...
    <div class="wheelchairs1-content" data-product-id="99">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="ŠTAP ČETVOROKRAKI MOBIAK TIP 922">
    ...
    <div class="wheelchairs1-content" data-product-id="100">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="ŠTAP ČETVOROKRAKI 76">
    ...
    <div class="wheelchairs1-content" data-product-id="101">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="ŠTAP NA PRODUŽENJE SILVER">
    ...
    <div class="wheelchairs1-content" data-product-id="102">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="ŠTAP ČETVOROKRAKI FDSFS 68">
    ...
    <div class="wheelchairs1-content" data-product-id="103">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="ŠTAP ČETVOROKRAKI BLUE">
    ...
    <div class="wheelchairs1-content" data-product-id="104">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="ŠTAP ČETVOROKRAKI M">
            <input type="hidden" name="product_price" value="2500">
            <button type="submit" class="buy">Dodaj u korpu</button>
        </form>
    </div>
    ...
    <div class="wheelchairs1-content" data-product-id="105">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="ŠTAP ČETVOROKRAKI S">
