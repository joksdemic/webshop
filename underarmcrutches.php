...
<div class="wheelchairs-h1"><h1>Podpazušne štake</h1></div>
...
<div class="wheelchairs1">
    ...
    <div class="wheelchairs1-content" data-product-id="70">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="PODPAZUŠNE ŠTAKE ALUMINIJUMSKE">
    ...
    <div class="wheelchairs1-content" data-product-id="74">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="PODPAZUŠNE ŠTAKE LIGHT ALLOY">
