...
<div class="wheelchairs-h1"><h1>Štapovi sa tri tačke oslonca</h1></div>
...
<div class="wheelchairs1">
    ...
    <div class="wheelchairs1-content" data-product-id="88">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="ŠTAP TROKRAKI MOBIAK TIP 926">
    ...
    <div class="wheelchairs1-content" data-product-id="89">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="ŠTAP TROKRAKI FS 926">
            <input type="hidden" name="product_price" value="1500">
            <button type="submit" class="buy">Dodaj u korpu</button>
        </form>
    </div>
    ...
    <div class="wheelchairs1-content" data-product-id="90">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="ŠTAP TROKRAKI">
