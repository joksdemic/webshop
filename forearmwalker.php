...
<div class="wheelchairs1">
    ...
    <div class="wheelchairs1-content" data-product-id="52">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="PODLAKATNA HODALICA PLUS">
    ...
    <div class="wheelchairs1-content" data-product-id="53">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="PODLAKATNA HODALICA FREEDOM">
    ...
    <div class="wheelchairs1-content" data-product-id="54">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="HODALICA TROTTER PODLAKATNA MOBIAK TIP 9612">
            <input type="hidden" name="product_price" value="18590">
            <button type="submit" class="buy">Dodaj u korpu</button>
        </form>
    </div>
    ...
    <div class="wheelchairs1-content" data-product-id="55">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="PODLAKATNA HODALICA 124 TROTTER">
    ...
    <div class="wheelchairs1-content" data-product-id="56">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="PODLAKATNA HODALICA PILOT TROTTER">
            <input type="hidden" name="product_price" value="26700">
            <button type="submit" class="buy">Dodaj u korpu</button>
        </form>
    </div>
    ...
    <div class="wheelchairs1-content" data-product-id="57">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="PODLAKATNA HODALICA ASPIRE">
    ...
    <div class="wheelchairs1-content" data-product-id="58">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="PODLAKATNA HODALICA STYLE">
    ...
    <div class="wheelchairs1-content" data-product-id="59">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="PODLAKATNA HODALICA W324">
    ...
    <div class="wheelchairs1-content" data-product-id="60">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="PODLAKATNA HODALICA TITAN">
            <input type="hidden" name="product_price" value="25790">
            <button type="submit" class="buy">Dodaj u korpu</button>
        </form>
    </div>
</div>
