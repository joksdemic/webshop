...
<div class="wheelchairs-h1"><h1>Aktivna kolica</h1></div>
...
<div class="wheelchairs1">
    <div class="wheelchairs1-content" data-product-id="25">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="AKTIVNA MEHANIČKA KOLICA Escape TT/TS">
    ...
    <div class="wheelchairs1-content" data-product-id="26">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="AKTIVNA MEHANIČKA KOLICA Avanti 1736">
    ...
    <div class="wheelchairs1-content" data-product-id="27">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="AKTIVNA MEHANIČKA KOLICA SAGGITTA">
    ...
    <div class="wheelchairs1-content" data-product-id="28">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="AKTIVNA MEHANIČKA KOLICA FLASH 1135">
            <input type="hidden" name="product_price" value="24400">
            <button type="submit" class="buy">Dodaj u korpu</button>
        </form>
    </div>
    ...
    <div class="wheelchairs1-content" data-product-id="29">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="AKTIVNA MEHANIČKA KOLICA HURRICANE 1880">
            <input type="hidden" name="product_price" value="27150">
            <button type="submit" class="buy">Dodaj u korpu</button>
        </form>
    </div>
    ...
    <div class="wheelchairs1-content" data-product-id="30">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="AKTIVNA MEHANIČKA KOLICA SMART F 2360">
            <input type="hidden" name="product_price" value="33250">
            <button type="submit" class="buy">Dodaj u korpu</button>
        </form>
    </div>
    ...
    <div class="wheelchairs1-content" data-product-id="31">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="AKTIVNA MEHANIČKA KOLICA SMART S 2370">
    ...
    <div class="wheelchairs1-content" data-product-id="32">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="AKTIVNA MEHANIČKA KOLICA PANTHERA X">
    ...
    <div class="wheelchairs1-content" data-product-id="33">
        ...
        <form method="post" action="cart.php">
            ...
            <input type="hidden" name="product_name" value="AKTIVNA MEHANIČKA KOLICA PANTHERA U3">
            <input type="hidden" name="product_price" value="27000">
            <button type="submit" class="buy">Dodaj u korpu</button>
        </form>
    </div>
